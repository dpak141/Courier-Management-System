...
public class ViewCourier extends javax.swing.JFrame {

    public ViewCourier() {
        initComponents();
        this.setTitle("View Courier");
    ...
    private void loadData() {
        ...
        CourierDao cud = new CourierDaoImpl();
        try {
            fileData = cud.getAllCourierdetails();
            DefaultTableModel dtm = new DefaultTableModel(new String[]{"CID", "Date", "CustID", "Address", "Contact", "Source", "Destination", "Weight", "Cost", "Cou-Type"}, 0);
            ...
            Logger.getLogger(ViewCourier.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCourier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCourier().setVisible(true);
            }
        });
    }
